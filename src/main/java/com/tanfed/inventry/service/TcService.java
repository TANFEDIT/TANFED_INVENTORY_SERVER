...
public interface TcService {
	...
	public DataForTcBillEntry getDataForTcBillEntry(String officeName, String jwt, String godownName, String claimFor,
			String idNo, LocalDate fromDate, LocalDate toDate, String loadType, String clNo, String claimBillNo) throws Exception;
	...
	public DataForTcCheckMemo getDataForTcCheckMemo(String jwt, String officeName, String checkMemoNo, String month) throws Exception;
